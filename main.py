...
st.set_page_config(page_title="Full Fat Trend", page_icon=":rabbit2:", layout="wide")
st.header("Full Fat Trend")
...
def buscar(q: str):
    ...
    c = (
        ...
        .mark_bar()
        .encode(
            x=alt.X("fecha:T", title="fecha", scale=alt.Scale()),
